...
urlpatterns = [
    ...
    path('delete_cart_item/<uuid:uid>/', views.delete_cart_item, name='delete_cart_item'),
    ...
    path('add_wishlist/<uuid:v_uid>/<uuid:p_uid>/', views.add_wishlist, name='add_wishlist'),
    path('delete_wishlist/<uuid:uid>',views.delete_wishlist, name='delete_wishlist'),
    path('add_to_cart_from_wish/<uuid:uid>/', views.add_to_cart_from_wish, name='add_to_cart_from_wish')
]